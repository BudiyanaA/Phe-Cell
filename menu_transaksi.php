...
<body>
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                  <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    <li class="nav-item active">
                      <a class="nav-link" href="menu_transaksi.php">Home<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container" style="margin-top: 150px">
        <div class="row justify-content-center align-items-center">
            <h1 href="index.html" style="font-size: 75pt">Hi! <?php echo $_SESSION['nama_cust'];?></h1>
        </div>
        <div class="row justify-content-center align-items-center">
            <!-- <div class="welcome"> -->
                <div>
                    <a class="btn btn-outline-success awal" href="add.php">Beli</a>
                    <a class="btn btn-outline-success awal" href="bayar.php">Bayar</a>
                </div>
            <!-- </div> -->
        </div>
    </div>
